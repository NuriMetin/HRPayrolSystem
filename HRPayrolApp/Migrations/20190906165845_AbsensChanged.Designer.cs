...
namespace HRPayrolApp.Migrations
{
    ...
    [Migration("20190906165845_AbsensChanged")]
    partial class AbsensChanged
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("HRPayrolApp.Models.ExcusableAbsens", b =>
                {
                    b.Property<int>("ID")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);

                    b.Property<int?>("CompanyWorkPlaceAbsensID");

                    b.Property<string>("Name");

                    b.Property<int>("WorkerAbsensId");

                    b.HasKey("ID");

                    b.HasIndex("CompanyWorkPlaceAbsensID");

                    b.HasIndex("WorkerAbsensId");

                    b.ToTable("ExcusableAbsens");
                });
            ...
            modelBuilder.Entity("HRPayrolApp.Models.UnExcusableAbsens", b =>
                {
                    b.Property<int>("ID")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("HRPayrolApp.Models.ExcusableAbsens", b =>
                {
                    b.HasOne("HRPayrolApp.Models.CompanyWorkPlaceAbsens")
                        .WithMany("ExcusableAbsens")
                        .HasForeignKey("CompanyWorkPlaceAbsensID");

                    b.HasOne("HRPayrolApp.Models.WorkerAbsens", "WorkerAbsens")
                        .WithMany("ExcusableAbsens")
                        .HasForeignKey("WorkerAbsensId")
                        .OnDelete(DeleteBehavior.Cascade);
                });
