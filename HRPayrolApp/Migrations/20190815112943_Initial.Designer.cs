...
namespace HRPayrolApp.Migrations
{
    ...
    [Migration("20190815112943_Initial")]
            ...
            modelBuilder.Entity("HRPayrolApp.Models.Worker", b =>
                {
                    ...
                    b.Property<int>("WorkerDisMissId");
            ...
            modelBuilder.Entity("HRPayrolApp.Models.Worker", b =>
                {
                    ...
                    b.HasOne("HRPayrolApp.Models.WorkerDismiss", "Dismiss")
                        .WithMany("Workers")
                        .HasForeignKey("WorkerDisMissId")
                        .OnDelete(DeleteBehavior.Cascade);
                });
